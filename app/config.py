...
DEFAULT_CONFIG_YAML: Dict[str, Any] = {
    ...
    "variation_pools": {
        ...
        "openers": [
            "I came across your work on {topic} while reading about {field}, and it genuinely caught my attention.",
            "I've been reading about {field} lately, and your work on {topic} stood out to me.",
            "Your research on {topic} came up while I was trying to learn more about {field}, and a few of your questions stuck with me.",
            "I recently read about your work on {topic}, and it's stayed on my mind since.",
        ],
        "transitions": [
            "What stood out to me was",
            "What I keep coming back to is",
            "I was especially struck by",
            "The part I found genuinely interesting was",
        ],
        "interest_connectors": [
